...
Register_Class(CmdForceActive);

CmdForceActive::CmdForceActive(const char *name, int kind) : ::twsn::Command(name,kind)
{
    this->setDes(LINK);
    this->setCmdId(CMD_LIN_FORCE_ACTIVE);

    this->duration_var = 0;
}

CmdForceActive::CmdForceActive(const CmdForceActive& other) : ::twsn::Command(other)
{
    copy(other);
}

CmdForceActive::~CmdForceActive()
{
}

CmdForceActive& CmdForceActive::operator=(const CmdForceActive& other)
{
    if (this==&other) return *this;
    ::twsn::Command::operator=(other);
    copy(other);
...
void CmdForceActive::copy(const CmdForceActive& other)
{
    this->duration_var = other.duration_var;
}

void CmdForceActive::parsimPack(cCommBuffer *b)
{
    ::twsn::Command::parsimPack(b);
    doPacking(b,this->duration_var);
}

void CmdForceActive::parsimUnpack(cCommBuffer *b)
{
    ::twsn::Command::parsimUnpack(b);
    doUnpacking(b,this->duration_var);
}

double CmdForceActive::getDuration() const
{
    return duration_var;
}

void CmdForceActive::setDuration(double duration)
{
    this->duration_var = duration;
}

class CmdForceActiveDescriptor : public cClassDescriptor
{
  public:
    CmdForceActiveDescriptor();
    virtual ~CmdForceActiveDescriptor();
...
Register_ClassDescriptor(CmdForceActiveDescriptor);

CmdForceActiveDescriptor::CmdForceActiveDescriptor() : cClassDescriptor("twsn::CmdForceActive", "twsn::Command")
{
}

CmdForceActiveDescriptor::~CmdForceActiveDescriptor()
{
}

bool CmdForceActiveDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<CmdForceActive *>(obj)!=NULL;
}

const char *CmdForceActiveDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int CmdForceActiveDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount(object) : 1;
}

unsigned int CmdForceActiveDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *CmdForceActiveDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int CmdForceActiveDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='d' && strcmp(fieldName, "duration")==0) return base+0;
...
const char *CmdForceActiveDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *CmdForceActiveDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int CmdForceActiveDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    CmdForceActive *pp = (CmdForceActive *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string CmdForceActiveDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool CmdForceActiveDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *CmdForceActiveDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *CmdForceActiveDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
